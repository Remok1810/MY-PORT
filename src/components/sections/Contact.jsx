      ...
      <div className="container">
        <div className={`section-header ${isVisible ? 'animate-in' : ''}`}>
          ...
          <div className="social-links-container">
            <a href="https://www.instagram.com/real_life_remo?igsh=MWw3cGprZ3ZpbnVkdg==" target="_blank" rel="noopener noreferrer" className="social-icon-3d instagram">
            ...
            <a href="https://github.com/Remok1810" target="_blank" rel="noopener noreferrer" className="social-icon-3d github">
              <div className="icon-wrapper">
            ...
            <div className="social-icon-3d whatsapp" style={{ cursor: 'pointer' }}>
              <div className="icon-wrapper">
              ...
              <span className="tooltip">8072577491</span>
            </div>

            <a href="https://www.linkedin.com/in/kaleeshwaran-a-77217b24a" target="_blank" rel="noopener noreferrer" className="social-icon-3d linkedin">
              <div className="icon-wrapper">
